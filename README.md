...
Este trabajo presenta una exploración computacional de la Conjetura de Collatz mediante la implementación y análisis de una extensión del árbol inverso asociado a la secuencia. El objetivo principal es estudiar el comportamiento estructural y numérico de las trayectorias generadas por la función de Collatz, utilizando herramientas computacionales para construir, visualizar y analizar ramas del árbol inverso a gran escala.
